	...
	<div>
		...
		if (isset($_POST['author'])) {
			...
			try {
				...
				$sql = "SELECT author.first_name AS first_name, author.last_name AS last_name, book.title AS title FROM author, book WHERE (last_name = '$authorln') AND (author_id = author.id)";
